...
export const ANTHROPIC_REGULAR_MODELS = ['claude-3-5-haiku-20241022'];
export const ANTHROPIC_MODELS = [...ANTHROPIC_PREMIUM_MODELS, ...ANTHROPIC_REGULAR_MODELS];
...
export const LLAMA_PREMIUM_MODELS = ['llama-3.3-70b'];
export const LLAMA_MODELS = [...LLAMA_PREMIUM_MODELS];
