...
export declare const ANTHROPIC_PREMIUM_MODELS: readonly ["claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219", "claude-3-5-sonnet-20241022", "claude-3-5-sonnet-20240620"];
...
export declare const ANTHROPIC_MODELS: readonly ["claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219", "claude-3-5-sonnet-20241022", "claude-3-5-sonnet-20240620", "claude-3-5-haiku-20241022"];
...
export declare const ALL_MODELS: readonly ["claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219", "claude-3-5-sonnet-20241022", "claude-3-5-sonnet-20240620", "claude-3-5-haiku-20241022", "gpt-4.1-2025-04-14", "gpt-4o-2024-08-06", "o3-mini-2025-01-31", "deepseek-r1-distill-llama-70b", "llama-3.3-70b", "gemini/gemini-2.5-pro-preview-03-25", "meta-llama/llama-4-maverick-17b-128e-instruct", "grok-3"];
export type ModelType = (typeof ALL_MODELS)[number];
export declare const PREMIUM_MODELS: readonly ["claude-sonnet-4-20250514", "claude-3-7-sonnet-20250219", "claude-3-5-sonnet-20241022", "claude-3-5-sonnet-20240620", "gpt-4.1-2025-04-14", "gpt-4o-2024-08-06", "deepseek-r1-distill-llama-70b", "llama-3.3-70b", "gemini/gemini-2.5-pro-preview-03-25", "meta-llama/llama-4-maverick-17b-128e-instruct", "grok-3"];
...
export declare const DEFAULT_MODEL: "claude-3-5-sonnet-20241022";
